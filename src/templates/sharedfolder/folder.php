...
<div class="container-fluid py-4 px-4"> 
    <div class="row mb-2 align-items-end">
        <div class="col-lg-8">
            <h6 class="text-theme-dark fw-bold mb-0" ng-click="navigateto('app.myfiles')" type="button"><i class="fa-regular fa-folder-minus me-2"></i> Shared Folder <span ng-show="folderdata"><i class="fa-solid fa-angle-right me-1"></i>{{folderdata.category_name}}</span></h6>
        </div> 
    </div>
    <div class="row mt-5">
        <div class="col-lg-6">
        ...
        <div class="col-lg-12">
            <div class="table-in">
                <table class="table align-middle">
                    ...
                    <tbody>
                        <tr ng-repeat="files in filtered = (shfolderobj | filter: search) | limitTo:items_per_page:items_per_page*(current_page-1)">
                                ...
                                <div class="d-flex align-items-center justify-content-center">
                                    <div class="dropdown btn-dropdown">
                                        ...
                                        <ul class="dropdown-menu"> 
                                            ...
                                            <li> 
                                                <a class="dropdown-item" ng-click="remove_sharedfolder(files)"><i class="fa-regular fa-trash me-2"></i> Remove</a>
                                            </li> 
                                        </ul>
                                    </div>
                                </div>
