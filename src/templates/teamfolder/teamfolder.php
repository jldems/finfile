    ...
    <div class="row mb-2 align-items-center">
        <div class="col-lg-8">
            <h6 class="text-theme-dark fw-bold mb-0"> 
                <span ng-click="navigateto('app.team')" type="button" ng-class="currentpath == '/teamfolder_files'? 'swal2-icon-content' : ''"><i class="fa-regular fa-files me-2" ng-class="currentpath == '/teamfolder_files'? 'swal2-icon-content' : ''"></i> Team Folder </span>
                <span ng-if="currentpath == '/teamfolder_files'"><i class="fa-solid fa-angle-right me-1"></i> 
                {{teamfolderdata.team_name}}</h6></span>
            
        </div>
        <div class="col-lg-4" ng-show="!folderdata.shared_by">
            <div class="d-flex align-items-end justify-content-end" style="gap:10px"> 
                <input type="file" id="filesInput" multiple onchange="angular.element(this).scope().team_upload(this.files)" style="display: none;">
                        ...
                        <tr ng-repeat="files in filtered = (ffileobj | filter: search) | limitTo:items_per_page:items_per_page*(current_page-1)">
                            ...
                            <td class="text-center">
                                <div class="dropdown btn-dropdown">
                                    ...
                                    <ul class="dropdown-menu"> 
                                        <li> 
                                            <a class="dropdown-item" ng-click="download_team(files)"><i class="fa-regular fa-download me-2"></i> Download</a>
                                        </li> 
                                        <li> 
